...
import com.jetfiretool.core.convert.ConvertException;
import com.jetfiretool.core.convert.ConverterRegistry;
import com.jetfiretool.core.convert.impl.CollectionConverter;
...
final class InternalJSONUtil {
	 ...
	 * 用于识别类似于：com.luxiaolei.package.jetfire这类用点隔开的键
	 * 
