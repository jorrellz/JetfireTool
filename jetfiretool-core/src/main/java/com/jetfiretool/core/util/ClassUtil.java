...
import com.jetfiretool.core.convert.BasicType;
import com.jetfiretool.core.exceptions.UtilException;
...
import com.jetfiretool.core.lang.ClassScaner;
import com.jetfiretool.core.lang.Filter;
...
public class ClassUtil {
	 ...
	 * 
	 * <pre>
	 * isSimple为false: "com.xiaoleilu.jetfiretool.util.ClassUtil"
	 ...
	 * 例如：com.xiaoleilu.jetfiretool.StrUtil.isEmpty 或 com.xiaoleilu.jetfiretool.StrUtil#isEmpty
	 ...
	 * 
	 * @param <T> 对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.xiaoleilu.jetfiretool.StrUtil#isEmpty或com.xiaoleilu.jetfiretool.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.xiaoleilu.jetfiretool.util.ClassUtil =》 com.xiaoleilu.jetfiretool.util
	 * 
	 * @param clazz 类
	 * @return 包名
	 */
