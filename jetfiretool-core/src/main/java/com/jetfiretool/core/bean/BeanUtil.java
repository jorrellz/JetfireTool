package com.jetfiretool.core.bean;
...
import com.jetfiretool.core.map.CaseInsensitiveMap;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.jetfiretool.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.jetfiretool.TestEntity匹配cn.jetfiretool.TestEntity
	 * 
	 * @param bean Bean
