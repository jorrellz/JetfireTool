...
import com.jetfiretool.core.io.file.LineSeparator;
...
public class FileUtilTest {
	...
	public void delTest() {
		// 删除一个不存在的文件，应返回false
		boolean result = FileUtil.del("e:/Jetfire_test_3434543533409843.txt");
	...
	public void renameTest() {
		FileUtil.rename(FileUtil.file("jetfiretool.jpg"), "b.png", false, false);
	}

	@Test
	public void copyTest() throws Exception {
		File srcFile = FileUtil.file("jetfiretool.jpg");
		File destFile = FileUtil.file("jetfiretool.copy.jpg");
	...
	public void equlasTest() {
		// 源文件和目标文件都不存在
		File srcFile = FileUtil.file("d:/jetfiretool.jpg");
		File destFile = FileUtil.file("d:/jetfiretool.jpg");

		boolean equals = FileUtil.equals(srcFile, destFile);
		Assert.assertTrue(equals);

		// 源文件存在，目标文件不存在
		File srcFile1 = FileUtil.file("jetfiretool.jpg");
		File destFile1 = FileUtil.file("d:/jetfiretool.jpg");
	...
	public void listFileNamesTest() {
		...
		Assert.assertTrue(names.contains("jetfiretool.jpg"));
