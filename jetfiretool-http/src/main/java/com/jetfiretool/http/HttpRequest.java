...
import com.jetfiretool.core.codec.Base64;
...
import com.jetfiretool.core.io.resource.BytesResource;
import com.jetfiretool.core.io.resource.FileResource;
import com.jetfiretool.core.io.resource.MultiFileResource;
import com.jetfiretool.core.io.resource.MultiResource;
import com.jetfiretool.core.io.resource.Resource;
...
public class HttpRequest extends HttpBase<HttpRequest> {
	...
	private static final String BOUNDARY = "--------------------Jetfire_" + RandomUtil.randomString(16);
	...
	/**
	 * 设置Cookie<br>
	 * 自定义Cookie后会覆盖Jetfire的默认Cookie行为
	 * 
	 ...
	 * 2. Rest模式，此时body需要传入一个JSON或者XML字符串，Jetfire会自动绑定其对应的Content-Type
	 * </pre>
	 * 
	 * @param body 请求体
