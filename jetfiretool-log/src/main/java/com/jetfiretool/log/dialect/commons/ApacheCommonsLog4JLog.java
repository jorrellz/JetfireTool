package com.jetfiretool.log.dialect.commons;

import com.jetfiretool.core.util.StrUtil;
import com.jetfiretool.log.AbstractLocationAwareLog;
...
public class ApacheCommonsLog4JLog extends AbstractLocationAwareLog {
    ...
    @Override
    public void log(String fqcn, com.jetfiretool.log.level.Level level, Throwable t, String format, Object... arguments) {
        Level log4jLevel;
        switch (level) {
            case TRACE:
