...
import com.jetfiretool.log.AbstractLog;
...
public class TinyLog extends AbstractLog {
	...
	public void trace(String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.TRACE, format, arguments);
	}

	@Override
	public void trace(Throwable t, String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.TRACE, t, format, arguments);
	}
	...
	public void debug(String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.DEBUG, format, arguments);
	}

	@Override
	public void debug(Throwable t, String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.DEBUG, t, format, arguments);
	}
	...
	public void info(String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.INFO, format, arguments);
	}

	@Override
	public void info(Throwable t, String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.INFO, t, format, arguments);
	}
	...
	public void warn(String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.WARN, format, arguments);
	}

	@Override
	public void warn(Throwable t, String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.WARN, t, format, arguments);
	}
	...
	public void error(String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.ERROR, format, arguments);
	}

	@Override
	public void error(Throwable t, String format, Object... arguments) {
		log(com.jetfiretool.log.level.Level.ERROR, t, format, arguments);
	}

	// ------------------------------------------------------------------------- Log
	@Override
	public void log(com.jetfiretool.log.level.Level level, String format, Object... arguments) {
		LogEntryForwarder.forward(DEPTH, toTinyLevel(level), getLastArgumentIfThrowable(level, arguments), format, arguments);
	}

	@Override
	public void log(com.jetfiretool.log.level.Level level, Throwable t, String format, Object... arguments) {
		LogEntryForwarder.forward(DEPTH, toTinyLevel(level), t, format, arguments);
	}

	/**
	 * 将Jetfire的Level等级转换为Tinylog的Level等级
	 * 
	 * @param level Jetfire的Level等级
	 * @return Tinylog的Level
	 * @since 4.0.3
	 */
	private Level toTinyLevel(com.jetfiretool.log.level.Level level) {
		Level tinyLevel;
		switch (level) {
		case TRACE:
